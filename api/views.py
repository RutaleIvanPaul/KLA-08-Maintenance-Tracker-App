...
def signup():
    ...
    try:
        User.createUser(request.json.get('email'), generate_password_hash(
            request.json.get('password')), request.json.get('usertype'))
